...
type Keeper struct {
	...
	NewValidatorsCache collections.KeySet[string]
...
func NewKeeper(
	...
	k := Keeper{
		...
		NewValidatorsCache: collections.NewKeySet(sb, poa.NewValidatorsCacheKey, "new_validators", collections.StringKey),
